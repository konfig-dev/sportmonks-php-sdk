...
class CitiesApi extends \Sportmonks\CustomApi
{
    /**
     * @var ClientInterface
     */
...
/**
     ...
     * @return \Sportmonks\Model\CitiesAllResponse
     */
    public function all(
     ...
     * @throws \Sportmonks\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Sportmonks\Model\CitiesAllResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function allWithHttpInfo($version = null, string $contentType = self::contentTypes['all'][0], \Sportmonks\RequestOptions $requestOptions = new \Sportmonks\RequestOptions())
    {
        ...
        try {
            ...
            switch($statusCode) {
                default:
                    if ('\Sportmonks\Model\CitiesAllResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Sportmonks\Model\CitiesAllResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Sportmonks\Model\CitiesAllResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Sportmonks\Model\CitiesAllResponse';
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Sportmonks\Model\CitiesAllResponse',
    ...
    public function allRequest($version = SENTINEL_VALUE, string $contentType = self::contentTypes['all'][0])
    {
        ...
        $resourcePath = '/{version}/core/cities';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * By ID
     *
     * @param  int $city_id The ID of the city you want to retrieve (required)
     * @param  string $version The version of the API. (optional)
     ...
     * @throws \Sportmonks\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Sportmonks\Model\CitiesGetByIdResponse
     */
    ...
    )
    {
        ...
        list($response) = $this->getByIdWithHttpInfo($city_id, $version, $contentType);
        return $response;
    }
     ...
     * @throws \Sportmonks\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Sportmonks\Model\CitiesGetByIdResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getByIdWithHttpInfo($city_id, $version = null, string $contentType = self::contentTypes['getById'][0], \Sportmonks\RequestOptions $requestOptions = new \Sportmonks\RequestOptions())
    {
        ["request" => $request, "serializedBody" => $serializedBody] = $this->getByIdRequest($city_id, $version, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                default:
                    if ('\Sportmonks\Model\CitiesGetByIdResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Sportmonks\Model\CitiesGetByIdResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Sportmonks\Model\CitiesGetByIdResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Sportmonks\Model\CitiesGetByIdResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Sportmonks\Model\CitiesGetByIdResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    )
    {
        ...
        return $this->getByIdAsyncWithHttpInfo($city_id, $version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getByIdAsyncWithHttpInfo($city_id, $version = null, string $contentType = self::contentTypes['getById'][0], \Sportmonks\RequestOptions $requestOptions = new \Sportmonks\RequestOptions())
    {
        $returnType = '\Sportmonks\Model\CitiesGetByIdResponse';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->getByIdRequest($city_id, $version, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getByIdRequest($city_id, $version = SENTINEL_VALUE, string $contentType = self::contentTypes['getById'][0])
    {

        // verify the required parameter 'city_id' is set
        if ($city_id === SENTINEL_VALUE || (is_array($city_id) && count($city_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter city_id when calling getById'
            );
        }
        // Check if $version is a string
        if ($version !== SENTINEL_VALUE && !is_string($version)) {
        ...
        $resourcePath = '/{version}/core/cities/{cityId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Sportmonks\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Sportmonks\Model\CitiesSearchResponse
     */
     ...
     * @throws \Sportmonks\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Sportmonks\Model\CitiesSearchResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($name, $version = null, string $contentType = self::contentTypes['search'][0], \Sportmonks\RequestOptions $requestOptions = new \Sportmonks\RequestOptions())
    {
        ...
        try {
            ...
            switch($statusCode) {
                default:
                    if ('\Sportmonks\Model\CitiesSearchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Sportmonks\Model\CitiesSearchResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Sportmonks\Model\CitiesSearchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Sportmonks\Model\CitiesSearchResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                default:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Sportmonks\Model\CitiesSearchResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function searchRequest($name, $version = SENTINEL_VALUE, string $contentType = self::contentTypes['search'][0])
    {
        ...
        $resourcePath = '/{version}/core/cities/search/{name}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
